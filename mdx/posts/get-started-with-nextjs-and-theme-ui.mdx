...
backgroundImage: "https://images.unsplash.com/photo-1611745179863-e123a89795fa?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80"
isDraft: false
tags: [Typescript, "Theme-UI", Next.js]
---

<Image
  alt="Picture by Polina Sushko"
  caption="Picture by Polina Sushko"
  my={4}
...
<TOC>
  <TOC.Item>Installing Next.js</TOC.Item>
  <TOC.Item>Adding Theme-UI</TOC.Item>
  <TOC.Item>What Now? Where's My UI?</TOC.Item>
  <TOC.Item>Bonus: Global Resets</TOC.Item>
  <TOC.Item>Bonus: Gimme Some Lint</TOC.Item>
  <TOC.Item>Resources</TOC.Item>
</TOC>
...
```typescript title="pages/_document.tsx"
import Document, {
  Html,
  Head,
  Main,
...
```typescript title="styles/theme.ts"
...
```typescript title="pages/_app.tsx" hl="2,3,7...10" showlineNumbers
import type { AppProps } from "next/app";
...
```typescript title="pages/_document.tsx" hl="8,26" showlineNumbers
import Document, {
  Html,
  Head,
  Main,
...
```typescript title="styles/Reset.tsx"
...
```typescript title="pages/_app.tsx" hl="4,9" showlineNumbers
import type { AppProps } from "next/app";
import { ThemeProvider } from "@theme-ui/core";
import { theme } from "../styles/theme";
...
```json title="package.json" showlineNumbers hl="9,22...25"
{
