...
published: "2021-08-17 19:00:00"
backgroundImage: "https://images.unsplash.com/photo-1576502200916-3808e07386a5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=746&q=80"
isDraft: false
...
<TOC>
  <TOC.Item>Creating a Link Component</TOC.Item>
  <TOC.Item>Making The Active Link</TOC.Item>
  <TOC.Item>Making The External Link Variant</TOC.Item>
  <TOC.Item>Making The Button Variant</TOC.Item>
  <TOC.Item>Final Thoughts</TOC.Item>
</TOC>
...
```typescript title="Link.tsx" showlineNumbers
...
```typescript title="style/theme.ts" 
...
all of our Next.js routing needs 🔥. The final result should look something like this:

<Flex mb={4} sx={{ justifyContent: "space-around", flexWrap: 'wrap' }}>
  <Link my={2} mx={2} href="#internal-link">Internal Link</Link>
  <Link my={2} mx={2} isActive href="/posts/next-link-with-theme-ui">Active Link</Link>
  <Link my={2} mx={2} href="https://www.google.ca/">External Link</Link>
  <Link.Button my={2} mx={2} href="#button-link">Button Link</Link.Button>
</Flex>
